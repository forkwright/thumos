...
pub(crate) const DEFAULT_TX_TIMEOUT_MS: u32 = 180;
...
pub(crate) const MIN_TX_TIMEOUT_MS: u32 = 10;
...
pub(crate) const MAX_TX_TIMEOUT_MS: u32 = 10_000;
...
/// link-dead detection.
pub(crate) const MAX_RETRY_LIMIT: u8 = 64;
...
pub(crate) const DEFAULT_POLL_TIMEOUT_ITERS: u32 = 1_000;
...
pub(crate) const MIN_POLL_TIMEOUT_ITERS: u32 = 100;
...
/// a clean error.
pub(crate) const MAX_POLL_TIMEOUT_ITERS: u32 = 1_000_000;
...
pub(crate) struct Config {
    ...
    pub(crate) poll_timeout_iters: u32,
}
...
impl Config {
    ...
    #[must_use]
    pub(crate) fn tx_timeout_ms(&self) -> u32 {
        bounded_u32(
            self.tx_timeout_ms,
    ...
    #[must_use]
    pub(crate) fn retry_limit(&self) -> u8 {
    ...
    #[must_use]
    pub(crate) fn poll_timeout_iters(&self) -> u32 {
        bounded_u32(
