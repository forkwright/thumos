...
- Signal detection and analysis (cellular, WiFi, Bluetooth)
- Counter-surveillance tools
- Kernel-level modifications to a production mobile device

These capabilities are provided for research, education, operational security, and personal use. The authors take no position on and accept no responsibility for any specific use, lawful or unlawful, of these capabilities by third parties.
...
- Loss of warranty or manufacturer support due to device modification
